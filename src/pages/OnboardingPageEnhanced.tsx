...
import { CheckCircleIcon, HomeModernIcon, UserGroupIcon } from '@heroicons/react/24/outline'
...
export default function OnboardingPageEnhanced() {
      ...
      {[1, 2, 3].map(s => (
        <div
          ...
          style={{
            ...
            height: '4px',
            background: s <= step ? 'var(--bronze-light)' : 'rgba(255,255,255,0.2)',
            borderRadius: '2px',
  ...
  return (
    <div className="app-root login-page" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh' }}>
      <div className="card" style={{ maxWidth: 520, width: '100%', margin: '1rem' }}>
        {renderProgressBar()}
        
        <h2 style={{ textAlign: 'center', marginBottom: '0.5rem' }}>
          {step === 1 && '👋 Willkommen!'}
          {step === 2 && (mode === 'create' ? '🏠 Haushalt gründen' : '🤝 Haushalt beitreten')}
          {step === 3 && '🎉 Geschafft!'}
        </h2>
        ...
        <p className="muted" style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
          ...
          {step === 2 && mode === 'join' && 'Tritt einem bestehenden Haushalt bei'}
        ...
        {step === 1 && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            >
              <HomeModernIcon style={{ width: 32, height: 32, flexShrink: 0 }} />
              <div>
                <div style={{ fontWeight: 'bold', marginBottom: '0.25rem' }}>Neuen Haushalt gründen</div>
                <div style={{ fontSize: '0.85rem', opacity: 0.8 }}>Erstelle einen neuen Haushalt und lade Mitglieder ein</div>
              </div>
            </button>
            ...
            >
              ...
              <div>
                <div style={{ fontWeight: 'bold', marginBottom: '0.25rem' }}>Bestehendem Haushalt beitreten</div>
                <div style={{ fontSize: '0.85rem', opacity: 0.8 }}>Nutze einen Einladungscode von deinem Admin</div>
              </div>
            </button>
          </div>
        )}
        ...
        {/* Step 2: Form */}
        {step === 2 && mode === 'create' && (
          <form className="form" onSubmit={createHousehold} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div>
            ...
            <div style={{ display: 'flex', gap: '0.5rem', marginTop: '0.5rem' }}>
              ...
              <button className="primary" type="submit" disabled={loading} style={{ flex: 2 }}>
        ...
        {step === 2 && mode === 'join' && (
          <form className="form" onSubmit={joinHousehold} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div>
              <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.9rem', fontWeight: 500 }}>
                Einladungscode
              </label>
        ...
        {step === 3 && (
          <div style={{ textAlign: 'center', padding: '2rem 0' }}>
            ...
            <p style={{ fontSize: '1.1rem', marginBottom: '0.5rem' }}>
              {mode === 'create' ? 'Haushalt erfolgreich erstellt!' : 'Erfolgreich beigetreten!'}
            </p>
