...
export default function LoginPageEnhanced({ onAuthSuccess }: Props) {
  ...
  return (
    ...
    >
      <div
        className="card"
        style={{ maxWidth: 460, width: "100%", margin: "1rem" }}
      >
        ...
        >
          <button
            ...
            style={{
              ...
              padding: "0.75rem",
              background:
                mode === "login" ? "rgba(255,255,255,0.15)" : "transparent",
              border: "none",
              borderBottom:
                mode === "login"
          ...
          <button
            ...
            style={{
              ...
              padding: "0.75rem",
              background:
                mode === "signup" ? "rgba(255,255,255,0.15)" : "transparent",
              border: "none",
              borderBottom:
                mode === "signup"
                  ? "2px solid var(--bronze-light)"
        ...
        {pendingInvite && (
          ...
          >
            ...
            <div
              style={{ fontSize: "0.8rem", marginTop: "0.25rem", opacity: 0.8 }}
            >
        ...
        >
            ...
            <div style={{ position: "relative" }}>
              ...
              {emailValid !== null && (
                ...
                >
                  {emailValid ? (
                    <CheckCircleIcon
                      style={{ width: 20, height: 20, color: "#6be76b" }}
                    />
                  ) : (
                    <XCircleIcon
                      style={{ width: 20, height: 20, color: "#ff6b6b" }}
                    />
                  )}
                </div>
              )}
          ...
          <button
            ...
            type="submit"
            disabled={
              loading || (mode === "signup" && (!emailValid || !passwordsMatch))
            }
            style={{
              opacity:
                loading ||
                (mode === "signup" && (!emailValid || !passwordsMatch))
                  ? 0.5
                  : 1,
              cursor:
                loading ||
